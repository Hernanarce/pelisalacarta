...
def mainlist(item):
    ...
    itemlist.append(Item(channel=item.channel,
                         ...
                         thumbnail='https://s31.postimg.org/9ooh78xej/votadas.png',
                         fanart='https://s31.postimg.org/9ooh78xej/votadas.png'
                         ))
    ...
    itemlist.append(Item(channel=item.channel,
                         ...
                         thumbnail='https://s31.postimg.org/6sksfqarf/dvd.png',
                         fanart='https://s31.postimg.org/6sksfqarf/dvd.png'
                         ))
    ...
    itemlist.append(Item(channel=item.channel,
                         ...
                         thumbnail='https://s31.postimg.org/tucv1wmgr/actualizadas.png',
                         fanart='https://s31.postimg.org/tucv1wmgr/actualizadas.png'
                         ))
