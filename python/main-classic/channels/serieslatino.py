...
def mainlist(item):
    ...
    itemlist.append(item.clone(title="Series", action="lista", thumbnail='https://s32.postimg.org/544rx8n51/series.png',
                               fanart='https://s32.postimg.org/544rx8n51/series.png', extra='peliculas/',
                               url=host + 'lista-de-series/'))

    itemlist.append(
        itemlist[-1].clone(title="Doramas", action="lista", thumbnail='https://s30.postimg.org/ors2tiqht/doramas.png',
                           fanart='https://s30.postimg.org/ors2tiqht/doramas.png', url=host + 'lista-de-doramas/',
                           extra='/genero'))

    itemlist.append(
        itemlist[-1].clone(title="Generos", action="generos", thumbnail='https://s31.postimg.org/szbr0gmkb/generos.png',
                           fanart='https://s31.postimg.org/szbr0gmkb/generos.png', url=host, extra='/genero'))
...
def findvideos(item):
    ...
    for scrapedlang, encurl in matches:
        ...
        title = ''
        server =''
        servers = {'/opl':'openload','/your':'yourupoad','/sen':'senvid','/face':'netutv','/vk':'vk'}
